...
public class SeparateChainingHashTable <AnyType> {
	...
	public static void main(String[] args) {
		SeparateChainingHashTable<Integer> separateChainingHashTable = new SeparateChainingHashTable<>();
		for(int i = 0; i < 400; i += 5) {
			separateChainingHashTable.insert(i);
		}
		for(int i = 0; i < 30; i++) {
			if(separateChainingHashTable.contains(i)) {
