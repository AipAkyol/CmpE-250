...
public class Project3 {
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        if (args.length != 3) {
            System.err.println("Usage: java Project3 <songfile> <inputfile> <outputfile>");
            System.exit(1);
        }
        ...
        Sort.countingSortByPlayCount(infoDatabase.sortedSongsbyPlayCount, 10000);
    ...
    public static class Sort { // use songs playcounts in descending order of play counts. 
